// code from http://cssdeck.com/labs/image-nodes
// described on http://cssdeck.com/labs/full/image-nodes AND https://github.com/raphamorim/awesome-canvas as Image Nodes
var particleHeader = function(pathToImg) {
  (function() {
    var lastTime = 0;
  ...
  var heightScale = 0.6; // Mitchell defined this
  ...
  var Nodes = {
    ...
    init: function(imgBase64) {
      // Set up the visual canvas
      this.canvas = document.getElementById("canvas");
      this.context = canvas.getContext("2d");
      this.context.globalCompositeOperation = "lighter";
      this.canvas.width = window.innerWidth;
      this.canvas.height = window.innerHeight * heightScale;
      ...
      window.onresize = function(event) {
        ...
        Nodes.canvas.height = window.innerHeight * heightScale;
        Nodes.onWindowResize();
      };

      // Load initial input image
      this.loadData(imgBase64);
    },
  ...
  function convertImgToBase64(src) {
  ...
  convertImgToBase64(pathToImg).then(base64Img => {
    Nodes.init(base64Img);
  });
}
